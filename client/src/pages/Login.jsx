    ...
    <div className="min-h-screen w-full bg-(--color-bg) flex items-center justify-center px-4">
      <div className="w-full max-w-[430px] mx-auto">
        <div className="bg-(--color-card) border border-(--color-border) rounded-2xl p-6">
          <h1 className="text-2xl font-bold text-(--color-text) mb-1">Welcome back</h1>
          <p className="text-sm text-(--color-text-muted) mb-6">Sign in to keep tracking your workouts</p>
